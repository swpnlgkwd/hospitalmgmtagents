    ...
    public static class ResolveRelativeDateTool
    {
        public static FunctionToolDefinition GetTool()
        {
            return new FunctionToolDefinition(
                ...
                description: "Only use this tool when the user mentions vague or relative date phrases like 'today', 'tomorrow', 'next week', 'this weekend', 'last month', etc. Do NOT use this tool for absolute or formatted dates (e.g., '2025-07-20', '20th July', or 'next Monday at 5 PM'). The result will be a resolved date or date range in yyyy-MM-dd format.",
